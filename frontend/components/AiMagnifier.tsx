export default function AiMagnifier({ className = "" }: { className?: string }) {
  return <span aria-hidden="true" className={`fitproof-ai-magnifier ${className}`}>
    ...
    <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" opacity="0.76">
      <defs><linearGradient id="fitproof-lens-rim" x1="6" y1="5" x2="51" y2="54" gradientUnits="userSpaceOnUse"><stop stopColor="#8ee9df"/><stop offset=".5" stopColor="#5fd8cd"/><stop offset="1" stopColor="#35bdb3"/></linearGradient></defs>
      ...
      <circle cx="24" cy="24" r="19" fill="rgba(95,216,205,.045)" stroke="url(#fitproof-lens-rim)" strokeWidth="5" />
