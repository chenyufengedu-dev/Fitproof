    ...
    <div className={`chat-markdown whitespace-normal break-words ${className}`}>
      <ReactMarkdown
        ...
        components={{
          ...
          ol: ({ children }) => <ol className="my-1.5 list-decimal space-y-1 pl-5 marker:font-bold marker:text-[#0B6E63]">{children}</ol>,
          ...
          a: ({ href, children }) => <a href={href} target="_blank" rel="noreferrer" className="font-semibold text-[#0B6E63] underline decoration-[#7BDDD2] underline-offset-2">{children}</a>,
