        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative flex flex-col items-center justify-center gap-0.5 text-[11px] font-medium transition-colors ${active ? 'text-[#0B6E63]' : 'text-slate-600 hover:text-[#0B6E63]'}`}
